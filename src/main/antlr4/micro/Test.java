...
public class Test
{
  ...
  public Test(String[] args)
  {
    try
    {
      ...
      l = new microLexer(new ANTLRInputStream(input));
    ...
    p = new microParser(new CommonTokenStream(l));
            p.addErrorListener(new BNFCErrorListener());
  }

  public micro.Absyn.Prog parse() throws Exception
  {
    /* The default parser is the first-defined entry point. */
    /* Other options are: */
    /* stm, exp, listIdent, listExp, listStm */
    microParser.Start_ProgContext pc = p.start_Prog();
    micro.Absyn.Prog ast = pc.result;
    System.out.println();
